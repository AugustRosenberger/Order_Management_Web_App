...
$delivAddress = $_POST["delivAddr"];
$orderNumber = rand(0000,9999);
$floristID = $_SESSION["FloristID"];
...
//////////////////////////////////////////////
	...
	$sql = "INSERT INTO `OrderInfo` VALUES ('$arrangement','$delivDate','$delivAddress', '$orderNumber', '$custID', '$floristID')";
	$result=mysqli_query($con,$sql); 
	...
	echo "<table class='center' align='center' border='1' style='width:800px; line-height:40px; top=200px;'>
		<tr>
			<th colspan='6'><h2>New Order Placed:</h2></th>
		</tr>
		<tr>
			<th>Order Type</th>
			<th>Delivery Date</th>
